function Header() {
  return (
    <header className="text-center mt-6 p-10 pt-14 md:pt-12 transform transition duration-500">
      <div className="overflow-auto h-96 md:h-[85vh] bg-gray-200 dark:bg-gray-800  transform transition duration-500 border-solid border-4 justify-between border-orange-500 text-gray-800 dark:text-gray-300 rounded flex flex-col">
        ...
        <div className="text-right text-black dark:text-white mt-20 sm:mt-0 p-4 md:pl-10 text-md lg:text-2xl xl:text-4xl font-prata">
