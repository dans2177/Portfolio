...
function Header() {
  return (
    <header className="text-center p-4 mt-12 pb-10">
      <div className="h-auto border-solid border-4 border-amber-400 rounded">
        <div className="flex-col justify-start p-4 m-4">
          <h1 className="animate-slide-top text-2xl font-bold text-left font-prata md:text-3xl lg:text-4xl">Hello! My name is</h1> 
