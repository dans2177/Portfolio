  ...
  return (
    <nav className="absolute top-0 left-0 right-0 bg-orange-900  z-10">
      <ul className="flex space-x-4 justify-center p-3 font-comfortaa">
        ...
        <li className={navItemClass} onClick={() => scrollToSection('projects')}>Projects</li>
        <li className={navItemClass} onClick={() => scrollToSection('skills')}>Skills</li>
        <li className={navItemClass} onClick={() => scrollToSection('contact')}>Contact</li>
      </ul>
    </nav>
  );
};
